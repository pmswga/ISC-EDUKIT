...
( 
	...
	CONSTRAINT XPKListFormEducation PRIMARY KEY  CLUSTERED (id_education_form ASC)
)
go
...
( 
	...
	CONSTRAINT R_22 FOREIGN KEY (id_education_form) REFERENCES ListEducationForm(id_education_form)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
...
( 
	id_admission_plan    integer IDENTITY ( 1,1 ) ,
	id_specialty         integer  NOT NULL ,
	admission_year       integer  NOT NULL ,
	count_person         integer  NOT NULL ,
	CONSTRAINT XPKAdmissionPlan PRIMARY KEY  CLUSTERED (id_admission_plan ASC),
	CONSTRAINT R_21 FOREIGN KEY (id_specialty) REFERENCES EducationSpecialty(id_specialty)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
...
( 
	id_payment_type      integer IDENTITY ( 1,1 ) ,
	caption              varchar(255)  NOT NULL ,
	CONSTRAINT XPKListPaymentType PRIMARY KEY  CLUSTERED (id_payment_type ASC)
)
go
...
CONSTRAINT R_11 FOREIGN KEY (id_student_general_information) REFERENCES StudentGeneralInformation(id_student_general_information)
		ON DELETE CASCADE
		ON UPDATE CASCADE,
CONSTRAINT R_23 FOREIGN KEY (id_payment_type) REFERENCES ListPaymentType(id_payment_type)
		ON DELETE NO ACTION
		ON UPDATE NO ACTION
)
go
