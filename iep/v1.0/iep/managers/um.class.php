<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT']."/iep/v1.0/iep/structures/teacher.class.php";
  require_once $_SERVER['DOCUMENT_ROOT']."/iep/v1.0/iep/structures/student.class.php";
  require_once $_SERVER['DOCUMENT_ROOT']."/iep/v1.0/iep/structures/parent.class.php";
  require_once $_SERVER['DOCUMENT_ROOT']."/iep/v1.0/iep/structures/group.class.php";
  require_once $_SERVER['DOCUMENT_ROOT']."/iep/v1.0/iep/structures/specialty.class.php";
