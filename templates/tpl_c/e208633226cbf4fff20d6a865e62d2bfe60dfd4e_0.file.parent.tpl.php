<?php
/* Smarty version 3.1.29, created on 2017-01-08 20:31:15
  from "C:\OpenServer\domains\iep.mgkit\templates\tpl\accounts\parent.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_58727763a112e0_90233754',
  'file_dependency' => 
  array (
...
function content_58727763a112e0_90233754 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="ru">
	<head>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion"><?php echo $_smarty_tpl->tpl_vars['child']->value['second_name'];?>
											...
											<div class="col-md-6">
												<fieldset>
													...
													<table class="table table-striped">
														<tr>
															<td>Email:</td>
															<td><?php echo $_smarty_tpl->tpl_vars['child']->value['email'];?>
</td>
														</tr>
														<tr>
															<td>Группа:</td>
															<td><?php echo $_smarty_tpl->tpl_vars['child']->value['grp'];?>
</td>
														</tr>
														<tr>
															<td>Дата рождения:</td>
															<td><?php echo $_smarty_tpl->tpl_vars['child']->value['date_birthday'];?>
</td>
														</tr>
														<tr>
															<td>Телефон:</td>
															<td><?php echo $_smarty_tpl->tpl_vars['child']->value['cell_phone'];?>
</td>
														</tr>
													</table>
												</fieldset>
